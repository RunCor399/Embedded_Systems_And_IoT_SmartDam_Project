...
public abstract class BluetoothChannel implements CommChannel {
    ...
    public void sendDamLevel(final int damLevel){
        final String message = "DAM;" + String.valueOf(damLevel);
        this.sendMessage(message);
    }

    public void sendManualState(){
        this.sendState("MANUAL");
    }

    public void sendAlarmState(){
        this.sendState("ALARM");
    }

    public void sendState(final String state){
